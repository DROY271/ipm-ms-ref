...
start "account-contrib" java -jar account-contrib/target/account-contrib-0.0.1-SNAPSHOT.jar
start "gateway" java -jar gateway/target/gateway-0.0.1-SNAPSHOT.jar